...
my_desc$set(Title = "Utilities for working with the 'gPAS'")

# The description of your package
my_desc$set(
  Description = paste0(
    "Utility functions used for working with the 'gPAS'",
...
# The urls
my_desc$set("URL", "https://github.com/joundso/gpas_connector")
my_desc$set("BugReports",
            "https://github.com/joundso/gpas_connector/issues")
